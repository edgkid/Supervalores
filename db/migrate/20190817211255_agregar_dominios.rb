class AgregarDominios < ActiveRecord::Migration[5.2]
  def change
    ...
    add_column :t_empresas, :t_empresa_tipo_valor_id, :bigint, null: false
    add_column :t_empresas, :t_empresa_sector_economico_id, :bigint, null: false
    add_column :t_tipo_clientes, :t_tipo_cliente_tipo_id, :bigint, null: false
